...
import static software.Login.conn;
import static software.Login.rs;
import static software.Login.st;
...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Enter the Emp name");

        jLabel6.setText("Salary to be changed is");

        jLabel7.setText("Employee to be fired is ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String query ="INSERT INTO emp(empname,salary,causal,medical) "
                    + "VALUES('"+name+"',"+s+","+c+","+m+")";
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String query ="UPDATE emp SET salary = "+s+" WHERE empname = '"+name+"'";
            st.executeUpdate(query);
        }
        catch(Exception e){
            System.out.println(e);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            String query ="DELETE FROM emp WHERE empname = '"+name+"'";
            st.executeUpdate(query);
        }
        catch(Exception e){
            System.out.println(e);
